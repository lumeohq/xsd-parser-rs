...
use crate::parser::types::{StructField, TypeModifier, StructFieldSource};
...
pub trait StructFieldGenerator {
    ...
    fn get_type_name(&self, entity: &StructField, gen: &Generator2) -> String {
    ...
    fn get_name(&self, entity: &StructField, gen: &Generator2) -> String {
        gen.base().format_name(entity.name.as_str()).into()
    }

    fn format_comment(&self, entity: &StructField, gen: &Generator2) -> String {
        gen
            .base()
    ...
    fn macros(&self, entity: &StructField, gen: &Generator2) -> String {
        match entity.source {
